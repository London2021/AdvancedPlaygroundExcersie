...
let totalTime = 3 + 3 + 10 + 10 + 15 + 10 + 15 + 5 + 7
...
let thingILike = useToilet + checkPhone + getDressed + brushTeeth + washFace
let thingIHave = makeBed + straightenRoom + eatBreakfast
