...
let feeOfRoomRental = 1000
let costOfPoster = 40
let totalTicketvalue = numberOfTickets * priceOfTicket
let totalExpenses = feeOfRoomRental + costOfPoster
let totalincomeOfshow = (numberOfTickets * priceOfTicket) - (feeOfRoomRental + costOfPoster)
//:
