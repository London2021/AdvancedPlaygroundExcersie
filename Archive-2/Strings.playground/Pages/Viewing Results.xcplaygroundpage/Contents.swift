...
//: Click the control that looks like an eye. This is the QuickLook control. A popover will appear showing you more of the string value.
//: 
//: Move the cursor over the control that looks like an outlined rectangle. This is the _show result_ button. If you click it, it will be highlighed and the result of that line of code will be added directly below the code. You can click this control again to hide the result.
//:
