...
let noun2 = "lake"
let possEmot = "livley"
let negEmot = "depressed"
let noun3 = "energy"

let sampleStory = "Today was a big day for \(fullName). They finally saved up \(dollarAmt) dollars and were going to buy a \(adJ) \(noun1). They went to the \(noun2) feeling very \(possEmot). But then they felt \(negEmot). They were all out of \(noun3)"
//:
//:
